...
export const BUILT_DISTRICTS: string[] = ["satkhira", "shariatpur", "noakhali", "habiganj", "barisal", "natore", "chuadanga", "meherpur", "madaripur", "sherpur", "barguna", "narayanganj", "nilphamari"];
